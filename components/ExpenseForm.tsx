...
import { PlusCircle, Wallet, Tag, FileText, ArrowUpCircle, ArrowDownCircle, Calendar } from 'lucide-react';
...
const ExpenseForm: React.FC<ExpenseFormProps> = ({ user, onSuccess }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Kita reset jam ke 00:00 untuk perbandingan tanggal murni
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 space-y-4">
      ...
      <div className="space-y-4">
        {/* TANGGAL TRANSAKSI (Sama Seperti History) */}
        <div>
        ...
        {/* KATEGORI (Hanya muncul jika pengeluaran) */}
        {type === 'expense' && (
          <div>
